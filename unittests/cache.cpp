...
void test_database_cache ()
{
  ...
  string testdatapath = filter_url_create_root_path_cpp17 ({"unittests", "tests", "cache_resource_test.sqlite"});
  string databasepath = filter_url_create_root_path_cpp17 ({"databases",  "cache_resource_unittests.sqlite"});
  string out_err;
