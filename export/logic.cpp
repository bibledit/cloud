...
{
  tasks_logic_queue (tasks::enums::task::export_all);
}
...
void export_logic::schedule_text_and_basic_usfm (const std::string& bible, bool log)
{
  ...
  for (auto book : books) {
    tasks_logic_queue (tasks::enums::task::export_text_usfm, {bible, std::to_string (book), filter::string::convert_to_string (log)});
  }
}
...
{
  tasks_logic_queue (tasks::enums::task::export_usfm, {bible, filter::string::convert_to_string (log)});
}
...
void export_logic::schedule_open_document (const std::string& bible, bool log)
{
  ...
  for (auto book : books) {
    tasks_logic_queue (tasks::enums::task::export_odt, {bible, std::to_string (book), filter::string::convert_to_string (log)});
  }
  // Export the whole Bible to one OpenDocument file.
  tasks_logic_queue (tasks::enums::task::export_odt, {bible, "0", filter::string::convert_to_string (log)});
}
...
{
  tasks_logic_queue (tasks::enums::task::export_info, {bible, filter::string::convert_to_string (log)});
}
...
void export_logic::schedule_html (const std::string& bible, bool log)
{
  std::vector <int> books = database::bibles::get_books (bible);
  for (auto book : books) {
    tasks_logic_queue (tasks::enums::task::export_html, {bible, std::to_string (book), filter::string::convert_to_string (log)});
  }
}
...
void export_logic::schedule_web (const std::string& bible, bool log)
{
  std::vector <int> books = database::bibles::get_books (bible);
  for (auto book : books) {
    tasks_logic_queue (tasks::enums::task::export_web_main, {bible, std::to_string (book), filter::string::convert_to_string (log)});
  }
}
...
{
  tasks_logic_queue (tasks::enums::task::export_web_index, {bible, filter::string::convert_to_string (log)});
}


void export_logic::schedule_online_bible (const std::string& bible, bool log)
{
  tasks_logic_queue (tasks::enums::task::export_online_bible, {bible, filter::string::convert_to_string (log)});
}


void export_logic::schedule_e_sword (const std::string& bible, bool log)
{
  tasks_logic_queue (tasks::enums::task::export_esword, {bible, filter::string::convert_to_string (log)});
}
