...
<p>
translate("The help information on this page uses a sample Google mail account.")
translate("You will have your own email account dedicated to Bibledit.")
</p>
<p>translate("The sample email address is bibletranslation@gmail.com, and the password is pazzwrd.")</p>
<p>
translate("Google now recommends two-factor authentication to be enabled.")
translate("The password to log into the Google account will not work in Bibledit.")
translate("Instead create an App Password on Google and use that as the password below.")
</p>
...
<form action="index#retrieve" name="retrieve" method="post">
  ...
  <p>translate("Password:") your-app-password</p>
  ...
  <table>
    ...
    <tr>
      ...
      <td><input type="password" name="storagepassword" maxlength="50" value="##storagepassword##" /></td>
    </tr>
    <tr>
...
<form action="index#send" name="send" method="post">
  ...
  <p>translate("Any port other than 25 will use a secure connection.")</p>
  <h4>translate("Enter the account details, and press Submit.")</h4>
  ...
  <table>
    ...
    <tr>
      <td align="right">translate("Password")</td>
      <td><input type="password" name="sendpassword" maxlength="50" value="##sendpassword##" /></td>
    </tr>
    <tr>
      <td align="right">translate("Port")</td>
