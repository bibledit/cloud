...
static unsigned int resource_external_count();
static std::string bibleserver_processor(std::string directory, int book, int chapter, int verse);
static std::string resource_external_get_statenbijbel_gbs(int book, int chapter, int verse);
static std::string resource_external_get_statenbijbel_plus_gbs(int book, int chapter, int verse);
static std::string resource_external_get_king_james_version_gbs(int book, int chapter, int verse);
static std::string resource_external_get_king_james_version_plus_gbs(int book, int chapter, int verse);
static std::string resource_external_get_biblehub_interlinear(int book, int chapter, int verse);
static std::string resource_external_get_biblehub_scrivener(int book, int chapter, int verse);
static std::string resource_external_get_biblehub_westminster(int book, int chapter, int verse);
static std::string resource_external_get_net_bible(int book, int chapter, int verse);
static std::string resource_external_get_blue_letter_bible(int book, int chapter, int verse);
static std::string resource_external_get_elberfelder_bibel(int book, int chapter, int verse);
static std::string resource_external_convert_book_biblehub(int book);
static std::string resource_external_convert_book_netbible(int book);
static std::string resource_external_convert_book_blueletterbible(int book);
static std::string resource_external_convert_book_bibleserver(int book);
...
resource_record resource_table[] =
{
    ...
    {
        "Statenbijbel Plus GBS", "Dutch Traditional", "Dutch Traditional", BIBLE,
        &resource_external_get_statenbijbel_plus_gbs
    },
    {
        "King James Version GBS", filter::string::english(), filter::string::english(), BIBLE,
        &resource_external_get_king_james_version_gbs
    },
    {
        "King James Version Plus GBS", filter::string::english(), filter::string::english(), BIBLE,
        &resource_external_get_king_james_version_plus_gbs
    },
    {
        resource_external_biblehub_interlinear_name(), filter::string::english(), filter::string::english(), ORIGINAL,
        &resource_external_get_biblehub_interlinear
    },
    {
        "Scrivener Greek", filter::string::english(), filter::string::english(), ORIGINAL,
        &resource_external_get_biblehub_scrivener
    },
    {
        "Westminster Hebrew", filter::string::english(), filter::string::english(), ORIGINAL,
        &resource_external_get_biblehub_westminster
    },
    {
        resource_external_net_bible_name(), filter::string::english(), filter::string::english(), BIBLE,
        &resource_external_get_net_bible
    },
    {
        "Blue Letter Bible", filter::string::english(), filter::string::english(), ORIGINAL,
        &resource_external_get_blue_letter_bible
    },
    {
        resource_external_elberfelder_bibel_name(), filter::string::english(), filter::string::english(), BIBLE,
        &resource_external_get_elberfelder_bibel
    },
    {
        resource_logic_easy_english_bible_name(), filter::string::english(), filter::string::english(), BIBLE,
        &resource_logic_easy_english_bible_get
    },
};
...
static std::string resource_external_get_statenbijbel_gbs(int book, int chapter, int verse)
{
    ...
    const std::string url = "https://bijbel-statenvertaling.com/statenvertaling/" +
        resource_external_convert_book_gbs_statenbijbel(book) + "/" + std::to_string(chapter) + "/";
...
static std::string resource_external_get_king_james_version_gbs(int book, int chapter, int verse)
{
    const std::string url = "https://bijbel-statenvertaling.com/authorised-version/" +
        resource_external_convert_book_gbs_king_james_bible(book) + "/" + std::to_string(chapter) + "/";
    return gbs_basic_processor(url, verse);
}
...
static std::string resource_external_get_biblehub_interlinear(int book, int chapter, int verse)
{
    ...
    const std::string url = "https://biblehub.com/interlinear/" + bookname + "/" + std::to_string(chapter) + "-" +
        std::to_string(verse) + ".htm";
    ...
    html = filter::string::replace(
        filter::string::unicode_non_breaking_space_entity() + filter::string::unicode_non_breaking_space_entity(),
        filter::string::unicode_non_breaking_space_entity(), std::move(html));
...
static std::string resource_external_get_biblehub_scrivener(int book, int chapter, int verse)
{
    ...
    const std::string url = "https://biblehub.com/text/" + bookname + "/" + std::to_string(chapter) + "-" +
        std::to_string(verse) + ".htm";
...
static std::string resource_external_get_net_bible(const int book, const int chapter, const int verse)
{
    ...
    {
        std::string error;
        const std::string url = "https://netbible.org/resource/netTexts/" + get_passage(false) +
            "?bible1Translation=net_strongs2";
        text = resource_logic_web_or_cache_get(url, error);
    ...
    std::string error;
    const std::string url = "https://netbible.org/resource/netNotes/" + get_passage(false) +
        "?bible1Translation=net_strongs2";
...
// Blue Letter Bible.
static std::string resource_external_get_blue_letter_bible(int book, int chapter, [[maybe_unused]] int verse)
{
    const std::string bookname = resource_external_convert_book_blueletterbible(book);

    std::string output;

    std::string url = "https://www.blueletterbible.org/Bible.cfm?b=" + filter_url_urlencode(bookname) + "&c=$" +
        std::to_string(chapter) + "&t=KJV&ss=1";

    output += "<a href=\"" + url + "\">KJV</a>";

    output += " | ";

    url = "https://www.blueletterbible.org/Bible.cfm?b=" + filter_url_urlencode(bookname) + "&c=" +
        std::to_string(chapter) + "&t=WLC";
