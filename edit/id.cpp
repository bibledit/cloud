...
std::string edit_id (Webserver_Request& webserver_request)
{
  ...
  webserver_request.database_config_user()->set_live_bible_editor (filter::date::get_seconds_since_epoch ());
  ...
  const int id = database::bibles::get_chapter_id (bible, book, chapter);
