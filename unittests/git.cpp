...
static void test_filter_git_setup ([[maybe_unused]] Webserver_Request& webserver_request,
                                   [[maybe_unused]] const std::string& bible,
                                   [[maybe_unused]] std::string new_bible,
                                   [[maybe_unused]] const std::string& psalms_0_data,
                                   [[maybe_unused]] const std::string& psalms_11_data,
                                   [[maybe_unused]] const std::string& song_of_solomon_2_data)
{
    if constexpr (config::logic::platform() == config::logic::Platform::cloud)
    {
        ...
        std::string newrepository = filter_git_directory (new_bible);
        ...
        bool result = filter_git_init(repository);
