...
[[nodiscard]] std::vector <book_id> get_ids ();
...
[[nodiscard]] short get_order_from_id (book_id id);
[[nodiscard]] book_type get_type (book_id id);
[[nodiscard]] std::string book_type_to_string (book_type type);
