...
void nmt_logic_export (string referencebible, string translatingbible)
{
  ...
  string reference_path = filter_url_create_root_path_cpp17 ({filter_url_temp_dir (), "reference_bible_nmt_training_text.txt"});
  string translation_path = filter_url_create_root_path_cpp17 ({filter_url_temp_dir (), "translation_bible_nmt_training_text.txt"});
