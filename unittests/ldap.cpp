...
void test_ldap ()
{
  ...
  string ldap_txt = filter_url_create_root_path_cpp17 ({config_logic_config_folder (), "ldap.txt"});
  string ldap_conf = filter_url_create_root_path_cpp17 ({config_logic_config_folder (), "ldap.conf"});
