...
void test_string ()
{
  ...
  // Test tidying html.
  {
    string folder = filter_url_create_root_path_cpp17 ({"unittests", "tests"});
  ...
  {
    string path_invalid = filter_url_create_root_path_cpp17 ({"unittests", "tests", "html-invalid-1.html"});
    ...
    string path_valid = filter_url_create_root_path_cpp17 ({"unittests", "tests", "html-fixed-1.html"});
