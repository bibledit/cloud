...
<h3>translate("Bibledit software")</h3>
<p>translate("Copyright (©) 2003-2026 Teus Benschop.")</p>
...
<h3>translate("Other code and data")</h3>
<p>translate("All the code and data included in Bibledit that does not fall in the above license categories has been licensed as mentioned in various bits of source code included in Bibledit.")
<a href="https://github.com/bibledit" ##external##>translate("See the source code repository.")</a>
</p>
