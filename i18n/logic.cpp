...
void i18n_logic_augment_via_google_translate ()
{
  ...
  std::map <string, std::string> localizations = locale_logic_localizations ();
  for (auto & element : localizations) {
    ...
    unordered_map <string, std::string> current_msgid_msgstr_map = locale_logic_read_msgid_msgstr (po_path);
    ...
    unordered_map <string, std::string> google_msgid_msgstr_map = locale_logic_read_msgid_msgstr (google_translate_txt_path);
