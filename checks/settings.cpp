...
std::string checks_settings(Webserver_Request& webserver_request)
{
    ...
    const std::string bible = access_bible::clamp(webserver_request,
                                                  webserver_request.database_config_user()->get_bible());
    ...
    view.set_variable("doublespacesusfm",
                      filter::string::get_checkbox_status(
                          database::config::bible::get_check_double_spaces_usfm(bible)));
    ...
    view.set_variable("fullstopheadings",
                      filter::string::get_checkbox_status(
                          database::config::bible::get_check_full_stop_in_headings(bible)));
    ...
    view.set_variable("spacebeforepunctuation",
                      filter::string::get_checkbox_status(
                          database::config::bible::get_check_space_before_punctuation(bible)));
    ...
    view.set_variable("spacebeforefinalnotemarkup",
                      filter::string::get_checkbox_status(
                          database::config::bible::get_check_space_before_final_note_marker(bible)));
    ...
    view.set_variable("sentencestructure",
                      filter::string::get_checkbox_status(
                          database::config::bible::get_check_sentence_structure(bible)));
    ...
    view.set_variable("paragraphstructure",
                      filter::string::get_checkbox_status(
                          database::config::bible::get_check_paragraph_structure(bible)));
    ...
    view.set_variable("booksversification",
                      filter::string::get_checkbox_status(
                          database::config::bible::get_check_books_versification(bible)));
    ...
    view.set_variable("chaptersversesversification",
                      filter::string::get_checkbox_status(
                          database::config::bible::get_check_chapters_verses_versification(bible)));
    ...
    view.set_variable("wellformedusfm",
                      filter::string::get_checkbox_status(database::config::bible::get_check_well_formed_usfm(bible)));
    ...
    view.set_variable("punctuationatendverse",
                      filter::string::get_checkbox_status(
                          database::config::bible::get_check_missing_punctuation_end_verse(bible)));
    ...
    view.set_variable(
        "patterns", filter::string::get_checkbox_status(database::config::bible::get_check_patterns(bible)));
    ...
    view.set_variable(
        "pairs", filter::string::get_checkbox_status(database::config::bible::get_check_matching_pairs(bible)));
    ...
    view.set_variable("spaceendverse",
                      filter::string::get_checkbox_status(database::config::bible::get_check_space_end_verse(bible)));
    ...
    view.set_variable("frenchpunctuation",
                      filter::string::get_checkbox_status(
                          database::config::bible::get_check_french_punctuation(bible)));
    ...
    view.set_variable("frenchcitation",
                      filter::string::get_checkbox_status(
                          database::config::bible::get_check_french_citation_style(bible)));
    ...
    view.set_variable("transposenotes",
                      filter::string::get_checkbox_status(
                          database::config::bible::get_transpose_fix_spaces_notes(bible)));
    ...
    view.set_variable("validutf8",
                      filter::string::get_checkbox_status(database::config::bible::get_check_valid_utf8_text(bible)));
