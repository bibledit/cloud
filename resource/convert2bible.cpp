...
{
  database::logs::logv1 (translate("Converting USFM Resource to Bible") + ": " + resource);
  ...
  database::logs::logv1 (translate("Conversion completed"));
}
