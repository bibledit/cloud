...
void test_database_books ()
{
  ...
  evaluate (__LINE__, __func__, static_cast <int> (book_type::old_testament), static_cast <int> (database::books::get_type_v1 (39)));
  ...
  evaluate (__LINE__, __func__, static_cast <int> (book_type::unknown), static_cast <int> (database::books::get_type_v1 (0)));
