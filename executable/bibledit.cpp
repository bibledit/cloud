...
#ifdef HAVE_WINDOWS
void my_invalid_parameter_handler(const wchar_t* expression, const wchar_t* function, const wchar_t* file,
                                  unsigned int line, uintptr_t pReserved)
{
    ...
    database::logs::log(
        "Invalid parameter detected in function", sfunction, "in file", sfile, "line", line,
...
int main()
{
    ...
    if (!backtrace.empty())
    {
        ...
        const std::vector<std::string> lines = filter::string::explode(backtrace, '\n');
