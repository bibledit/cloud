...
private:
  ...
  std::string file (std::string user) const;
  std::string file (std::string user, const char * key) const;
  ...
  bool getBValueForUser (std::string user, const char * key, bool default_value) const;
  int getIValueForUser (std::string user, const char * key, int default_value) const;
  void setValue (const char * key, std::string value) const;
  void setBValue (const char * key, bool value) const;
  void setIValue (const char * key, int value) const;
  void setValueForUser (std::string user, const char * key, std::string value) const;
  void setBValueForUser (std::string user, const char * key, bool value) const;
  std::vector <std::string> getList (const char * key) const;
  std::vector <std::string> getListForUser (std::string user, const char * key) const;
