...
void Filter_Text::add_usfm_code(std::string usfm)
{
    ...
    {
        database::logs::logv1(translate("Exporting invalid UTF-8.") + " " + translate("Please check.") + " " + usfm);
    }
    // Clean the USFM.
...
bool Filter_Text::unprocessed_usfm_code_available() const
{
...
void Filter_Text::pre_process_usfm()
{
    ...
    while (unprocessed_usfm_code_available())
    {
        ...
        for (chapter_usfm_markers_and_text_pointer = 0; chapter_usfm_markers_and_text_pointer <
             chapter_usfm_markers_and_text.size(); chapter_usfm_markers_and_text_pointer++)
        {
            if (std::string current_item = chapter_usfm_markers_and_text[chapter_usfm_markers_and_text_pointer];
                filter::usfm::is_usfm_marker(current_item))
            {
                ...
                if (filter::usfm::is_opening_marker(marker))
                {
                    if (const stylesv2::Style* style{database::styles::get_marker_data(m_stylesheet, marker)}; style)
                    {
                        ...
                        case stylesv2::Type::book_id:
                            {
                                // Get book number.
                                std::string usfm_id = filter::usfm::get_book_identifier(
                                    chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                                // Remove possible soft hyphen.
                                usfm_id = filter::string::replace(filter::string::soft_hyphen_u00AD(), std::string(),
                                                                  usfm_id);
                                // Get Bibledit book number.
                                m_current_book_identifier = static_cast<int>(
                                    database::books::get_id_from_usfm(usfm_id));
                        ...
                        case stylesv2::Type::running_header:
                            {
                                const std::string running_header = filter::usfm::get_text_following_marker(
                                    chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                                running_headers.push_back(filter::text::passage_marker_value(
                                    m_current_book_identifier, m_current_chapter_number, m_current_verse_number, marker,
                                    running_header));
                                break;
                            }
                        case stylesv2::Type::long_toc_text:
                            {
                                const std::string long_toc = filter::usfm::get_text_following_marker(
                                    chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                                long_TOCs.emplace_back(
                                    m_current_book_identifier, m_current_chapter_number, m_current_verse_number, marker,
                                    long_toc);
                                break;
                            }
                        case stylesv2::Type::short_toc_text:
                            {
                                const std::string short_toc = filter::usfm::get_text_following_marker(
                                    chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                                short_TOCs.emplace_back(
                                    m_current_book_identifier, m_current_chapter_number, m_current_verse_number, marker,
                                    short_toc);
                                break;
                            }
                        case stylesv2::Type::book_abbrev:
                            {
                                const std::string book_abbreviation = filter::usfm::get_text_following_marker(
                                    chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                                book_abbreviations.emplace_back(
                                    m_current_book_identifier, m_current_chapter_number, m_current_verse_number, marker,
                                    book_abbreviation);
                                break;
                            }
                        ...
                        case stylesv2::Type::chapter:
                            {
                                const std::string number = filter::usfm::get_text_following_marker(
                                    chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                        ...
                        case stylesv2::Type::chapter_label:
                            {
                                ...
                                const std::string chapter_label = filter::usfm::get_text_following_marker(
                                    chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                                chapter_labels.emplace_back(
                                    m_current_book_identifier, m_current_chapter_number, m_current_verse_number, marker,
                                    chapter_label);
                        ...
                        case stylesv2::Type::published_chapter_marker:
                            {
                                const std::string published_chapter_marker = filter::usfm::get_text_following_marker(
                                    chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                                published_chapter_markers.emplace_back(
                                    m_current_book_identifier, m_current_chapter_number, m_current_verse_number, marker,
                        ...
                        case stylesv2::Type::alternate_chapter_number:
                            {
                                const std::string alternate_chapter_number = filter::usfm::get_text_following_marker(
                                    chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                                alternate_chapter_numbers.emplace_back(
                                    m_current_book_identifier, m_current_chapter_number, m_current_verse_number, marker,
                        ...
                        case stylesv2::Type::verse:
                            {
                                const std::string fragment = filter::usfm::get_text_following_marker(
                                    chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                        ...
                        case stylesv2::Type::published_verse_marker:
                            {
                                ...
                                const std::string published_verse_marker = filter::usfm::get_text_following_marker(
                                    chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                                published_verse_markers.emplace_back(
                                    m_current_book_identifier, m_current_chapter_number, m_current_verse_number, marker,
...
void Filter_Text::process_usfm()
{
    ...
    while (unprocessed_usfm_code_available())
    {
        ...
        for (chapter_usfm_markers_and_text_pointer = 0; chapter_usfm_markers_and_text_pointer <
             chapter_usfm_markers_and_text.size(); chapter_usfm_markers_and_text_pointer++)
        {
            if (const std::string current_item = chapter_usfm_markers_and_text[chapter_usfm_markers_and_text_pointer];
                filter::usfm::is_usfm_marker(current_item))
            {
                ...
                if (is_opening_marker)
                    filter::usfm::remove_word_level_attributes(marker, chapter_usfm_markers_and_text,
                ...
                if (const stylesv2::Style* style{database::styles::get_marker_data(m_stylesheet, marker)}; style)
                {
                    ...
                    case stylesv2::Type::book_id:
                        {
                            ...
                            std::string usfm_id = filter::usfm::get_book_identifier(
                                chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                            usfm_id = filter::string::replace(filter::string::soft_hyphen_u00AD(), "", usfm_id);
                            // Remove possible soft hyphen.
                            ...
                            filter::usfm::get_text_following_marker(chapter_usfm_markers_and_text,
                                                                    chapter_usfm_markers_and_text_pointer);
                            ...
                            if (stylesv2::get_parameter<bool>(style, stylesv2::Property::starts_new_page))
                            {
                                if (processed_books_count)
                                {
                                    ...
                                    if (odf_text_text_and_note_citations) odf_text_text_and_note_citations->
                                        new_page_break();
                            ...
                            std::string runningHeader = database::books::get_english_from_id(
                                static_cast<book_id>(m_current_book_identifier));
                            for (const auto& item : running_headers)
                            {
                            ...
                            if (odf_text_text_and_note_citations) odf_text_text_and_note_citations->new_heading1(
                                runningHeader, true);
                    ...
                    case stylesv2::Type::paragraph:
                        {
                            if (is_opening_marker)
                            {
                                ...
                                if (headings_text_per_verse_active)
                                {
                                    ...
                                    if (const int i_verse = filter::string::convert_to_int(m_current_verse_number);
                                        m_verses_text.contains(i_verse) and not m_verses_text[i_verse].empty())
                                    {
                                        m_verses_text[i_verse].append(" ");
                                    }
                    ...
                    case stylesv2::Type::chapter:
                        {
                            ...
                            std::string usfm_c_fragment = filter::usfm::get_text_following_marker(
                                chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                            ...
                            std::string running_header = database::books::get_english_from_id(
                                static_cast<book_id>(m_current_book_identifier));
                            for (const auto& item : running_headers)
                            {
                                if (item.m_book == m_current_book_identifier)
                            ...
                            // for the first chapter. See https://github.com/bibledit/cloud/issues/905 for more info.
                            {
                                ...
                                if (stylesv2::get_parameter<bool>(style, stylesv2::Property::at_first_verse) && !
                                    cl_found)
                                {
                                ...
                                else
                                {
                                    ...
                                    std::string label_entire_book{};
                                    std::string label_current_chapter{};
                                    for (const auto& chapter_label : chapter_labels)
                                    {
                                        if (chapter_label.m_book == m_current_book_identifier)
                                        {
                                            ...
                                            {
                                                label_entire_book = chapter_label.m_value;
                                            }
                                            if (chapter_label.m_chapter == m_current_chapter_number)
                                            {
                                                label_current_chapter = chapter_label.m_value;
                                            }
                                        }
                                    }
                                    if (not label_entire_book.empty())
                                    {
                                        std::string fragment;
                                        fragment.append(label_entire_book);
                                        fragment.append(" ");
                                        fragment.append(usfm_c_fragment);
                                        usfm_c_fragment = std::move(fragment);
                                    }
                                    if (not label_current_chapter.empty())
                                    {
                                        usfm_c_fragment = label_current_chapter;
                                    }
                            ...
                            const stylesv2::Style* ft_style = database::styles::get_marker_data(
                                m_stylesheet, standard_content_marker_foot_end_note);
                    ...
                    case stylesv2::Type::verse:
                        {
                            ...
                            if (stylesv2::get_parameter<bool>(style, stylesv2::Property::restart_paragraph))
                            {
                                ...
                                if (odf_text_text_only)
                                {
                                    ...
                                    {
                                        odf_text_text_only->
                                            new_paragraph(odf_text_text_only->m_current_paragraph_style);
                                    }
                                }
                                if (odf_text_text_and_note_citations)
                                {
                                    ...
                                    {
                                        odf_text_text_and_note_citations->new_paragraph(
                                            odf_text_text_and_note_citations->m_current_paragraph_style);
                                    }
                                }
                                if (html_text_standard)
                                {
                            ...
                            if (!m_output_chapter_text_at_first_verse.empty())
                            {
                                ...
                                {
                                    const int drop_caps_length = static_cast<int>(filter::string::unicode_string_length(
                                        m_output_chapter_text_at_first_verse));
                                    apply_drop_caps_to_current_paragraph(drop_caps_length);
                                    if (odf_text_standard) odf_text_standard->add_text(
                                        m_output_chapter_text_at_first_verse);
                                    if (odf_text_text_only) odf_text_text_only->add_text(
                                        m_output_chapter_text_at_first_verse);
                                    if (odf_text_text_and_note_citations) odf_text_text_and_note_citations->add_text(
                                        m_output_chapter_text_at_first_verse);
                                }
                                else
                                {
                                ...
                                if (html_text_standard) html_text_standard->open_text_style(
                                    &dropcaps_style, false, false);
                                if (html_text_standard) html_text_standard->add_text(
                                    m_output_chapter_text_at_first_verse);
                            ...
                            std::string text_following_v_marker = filter::usfm::get_text_following_marker(
                                chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                            ...
                            {
                                if (const size_t pos = text_following_v_marker.find(v_number);
                                    pos != std::string::npos)
                                {
                                ...
                                if (m_output_chapter_text_at_first_verse.empty())
                                {
                                    if (odf_text_standard)
                                    {
                                        bool tab = odt_left_align_verse_in_poetry_styles &&
                                            filter::usfm::is_standard_q_poetry(
                                                odf_text_standard->m_current_paragraph_style);
                                    ...
                                    if (odf_text_text_only)
                                    {
                                        bool tab = odt_left_align_verse_in_poetry_styles &&
                                            filter::usfm::is_standard_q_poetry(
                                                odf_text_text_only->m_current_paragraph_style);
                            ...
                            if (onlinebible_text) onlinebible_text->newVerse(
                                m_current_book_identifier, m_current_chapter_number,
                                filter::string::convert_to_int(m_current_verse_number));
                            if (esword_text) esword_text->newVerse(
                                filter::string::convert_to_int(m_current_verse_number));
                            // Done.
                            break;
                        }
                    case stylesv2::Type::published_verse_marker:
                        {
                            ...
                            else
                            {
                                ...
                                if (const size_t pointer = chapter_usfm_markers_and_text_pointer + 1;
                                    pointer < chapter_usfm_markers_and_text.size())
                                {
                    ...
                    case stylesv2::Type::milestone:
                        {
                            const std::string data = filter::usfm::remove_milestone(
                                chapter_usfm_markers_and_text, chapter_usfm_markers_and_text_pointer);
                            if (!data.empty())
                            {
            ...
            else
            {
                ...
                if (is_within_figure_markup)
                {
                    ...
                    if (odf_text_text_and_note_citations) odf_text_text_and_note_citations->add_image(
                        figure_marker, alt, src, caption);
                ...
                else
                {
                    ...
                    if (odf_text_text_and_note_citations)
                        if (odt_left_align_verse_in_poetry_styles)
                            if (filter::usfm::is_standard_q_poetry(
                                odf_text_text_and_note_citations->m_current_paragraph_style))
                                if (odf_text_text_and_note_citations->m_current_paragraph_content.empty())
                    ...
                    if (headings_text_per_verse_active && text_started)
                    {
                        if (const int i_verse = filter::string::convert_to_int(m_current_verse_number);
                            m_verses_text.contains(i_verse) and not m_verses_text[i_verse].empty())
                        {
                            m_verses_text[i_verse].append(text_item);
                            actual_verses_paragraph[i_verse].append(text_item);
                        }
                        else
                        {
                            ...
                            m_verses_text[i_verse] = filter::string::ltrim(item);
                            actual_verses_paragraph[i_verse] = filter::string::ltrim(item);
                        }
                    }
                    if (note_open_now)
                    {
...
{
    for (; chapter_usfm_markers_and_text_pointer < chapter_usfm_markers_and_text.size();
           ++chapter_usfm_markers_and_text_pointer)
    {
        if (const std::string current_item = chapter_usfm_markers_and_text[chapter_usfm_markers_and_text_pointer];
            filter::usfm::is_usfm_marker(current_item))
                ...
                case stylesv2::Type::verse:
                    {
                        ...
                        add_to_fallout("The note did not close at the end of the verse. The text is not correct.",
                                       false);
                        goto noteDone;
                        break;
                    }
                ...
                case stylesv2::Type::footnote_wrapper:
                    {
                        if (is_opening_marker)
                        {
                            ...
                            if (odf_text_text_and_note_citations)
                            {
                                std::vector<std::string> current_text_styles = odf_text_text_and_note_citations->
                                    m_current_text_style;
                            ...
                            if (odf_text_notes)
                            {
                                if (not odf_text_notes->m_current_paragraph_content.empty())
                                {
                ...
                case stylesv2::Type::note_content_with_endmarker:
                    {
                        ...
                        {
                            if (odf_text_standard)
                                odf_text_standard->open_text_style(style, true, is_embedded_marker);
                            if (odf_text_notes)
                                odf_text_notes->open_text_style(style, false, is_embedded_marker);
                            if (html_text_standard)
                                html_text_standard->open_text_style(style, true, is_embedded_marker);
                            if (html_text_linked)
                                html_text_linked->open_text_style(style, true, is_embedded_marker);
                        }
                        else
                        {
                            if (odf_text_standard)
                                odf_text_standard->close_text_style(true, is_embedded_marker);
                            if (odf_text_notes)
                                odf_text_notes->close_text_style(false, is_embedded_marker);
                            if (html_text_standard)
                                html_text_standard->close_text_style(true, is_embedded_marker);
                            if (html_text_linked)
                                html_text_linked->close_text_style(true, is_embedded_marker);
                        }
                        break;
                    }
                case stylesv2::Type::note_paragraph:
                ...
                case stylesv2::Type::crossreference_wrapper:
                    {
                        if (is_opening_marker)
                        {
                            const stylesv2::Style* xt_style = database::styles::get_marker_data(
                                m_stylesheet, standard_content_marker_cross_reference);
                            ensure_note_paragraph_style(marker, xt_style);
                            std::string citation = get_note_citation(style->marker);
                            if (odf_text_standard)
                                odf_text_standard->add_note(citation, marker);
                            // Note citation in superscript in the document with text and note citations.
                            if (odf_text_text_and_note_citations)
...
noteDone:
    ...
    if (not notes_plain_text_buffer.empty())
    {
        notes_plain_text.emplace_back(m_current_verse_number, notes_plain_text_buffer);
    }
    note_open_now = false;
...
void Filter_Text::produce_info_document(const std::string& path) const
{
    ...
    for (const auto& [book, count] : m_number_of_chapters_per_book)
    {
        std::ostringstream oss{};
        oss << database::books::get_english_from_id(static_cast<book_id>(book)) << " => " << count;
        information.new_paragraph();
        information.add_text(std::move(oss).str());
    }
    ...
    for (const auto& item : running_headers)
    {
        const std::string line = database::books::get_english_from_id(static_cast<book_id>(item.m_book)) + " (USFM " +
            item.m_marker + ") => " + item.m_value;
        information.new_paragraph();
    ...
    for (const auto& item : short_TOCs)
    {
        const std::string line = database::books::get_english_from_id(static_cast<book_id>(item.m_book)) + " (USFM " +
            item.m_marker + ") => " + item.m_value;
        information.new_paragraph();
    ...
    for (const auto& item : book_abbreviations)
    {
        const std::string line = database::books::get_english_from_id(static_cast<book_id>(item.m_book)) + " (USFM " +
            item.m_marker + ") => " + item.m_value;
        information.new_paragraph();
    ...
    for (const auto& [marker, words] : word_lists)
    {
...
std::string Filter_Text::get_current_passage_text() const
{
...
void Filter_Text::add_to_info(std::string text, const bool next)
{
...
// and removes this text from the USFM input stream.
void Filter_Text::add_to_fallout(std::string text, const bool next)
{
    text = get_current_passage_text() + " " + text;
    if (next)
    {
...
{
    std::string text = filter::usfm::peek_text_following_marker(chapter_usfm_markers_and_text,
                                                                chapter_usfm_markers_and_text_pointer);
    text.append(" (");
...
// $path: Path to the document.
void Filter_Text::produce_fallout_document(const std::string& path) const
{
    HtmlText html_text(translate("Fallout"));
    html_text.new_heading1(translate("Fallout"));
    for (const std::string& line : fallout)
    {
...
void Filter_Text::create_paragraph_style(const stylesv2::Style* style, const bool keep_with_next)
{
    if (const std::string marker = style->marker;
        std::ranges::find(created_styles, marker) == created_styles.end())
    {
        ...
        if (style->paragraph)
        {
            ...
            const auto font_size = static_cast<float>(paragraph.font_size);
            ...
            constexpr int drop_caps{0};
            if (odf_text_standard)
                odf_text_standard->create_paragraph_style(marker, font_name, font_size, italic, bold, underline,
                                                          smallcaps, text_alignment, space_before, space_after,
                                                          left_margin, right_margin, first_line_indent, keep_with_next,
                                                          drop_caps);
            if (odf_text_text_only)
                odf_text_text_only->create_paragraph_style(marker, font_name, font_size, italic, bold, underline,
                                                           smallcaps, text_alignment, space_before, space_after,
                                                           left_margin, right_margin, first_line_indent, keep_with_next,
                                                           drop_caps);
            if (odf_text_text_and_note_citations)
                odf_text_text_and_note_citations->create_paragraph_style(
                    marker, font_name, font_size, italic, bold, underline, smallcaps, text_alignment, space_before,
                    space_after, left_margin, right_margin, first_line_indent, keep_with_next, drop_caps);
        }
...
void Filter_Text::new_paragraph(const stylesv2::Style* style, const bool keep_with_next)
{
...
void Filter_Text::apply_drop_caps_to_current_paragraph(const int drop_caps_length)
{
    // To name a style according to the number of characters to put in drop caps,
    // e.g. a style name like p_c1 or p_c2 or p_c3.
    if (odf_text_standard)
    {
        const std::string combined_style = odf_text_standard->m_current_paragraph_style + "_" + chapter_marker +
            std::to_string(drop_caps_length);
        if (std::ranges::find(created_styles, combined_style) == created_styles.end())
        {
            const stylesv2::Style* style = database::styles::get_marker_data(
                m_stylesheet, odf_text_standard->m_current_paragraph_style);
            if (!style)
                return;
            if (!style->paragraph)
                return;
            const std::string font_name = database::config::bible::get_export_font(m_bible);
            const auto font_size = static_cast<float>(style->paragraph.value().font_size);
            ...
            if (odf_text_standard)
                odf_text_standard->create_paragraph_style(combined_style, font_name, font_size, italic, bold, underline,
                                                          smallcaps, text_alignment, space_before, space_after,
                                                          left_margin, right_margin, first_line_indent, keep_with_next,
                                                          drop_caps_length);
            if (odf_text_text_only)
                odf_text_text_only->create_paragraph_style(combined_style, font_name, font_size, italic, bold,
                                                           underline, smallcaps, text_alignment, space_before,
                                                           space_after, left_margin, right_margin, first_line_indent,
                                                           keep_with_next, drop_caps_length);
            if (odf_text_text_and_note_citations)
                odf_text_text_and_note_citations->create_paragraph_style(
                    combined_style, font_name, font_size, italic, bold, underline, smallcaps, text_alignment,
                    space_before, space_after, left_margin, right_margin, first_line_indent, keep_with_next,
                    drop_caps_length);
...
void Filter_Text::put_chapter_number_in_frame(const std::string& chapter_text) const
{
...
{
    const bool end_of_text_reached = (chapter_usfm_markers_and_text_pointer + 1) >= chapter_usfm_markers_and_text.
        size();
...
// $style: The style to use.
void Filter_Text::ensure_note_paragraph_style(const std::string& marker, const stylesv2::Style* style)
{
    if (std::ranges::find(created_styles, marker) == created_styles.end())
    {
        if (!style)
            return;
        if (!style->paragraph)
        ...
        constexpr int drop_caps = 0;
        if (odf_text_standard)
            odf_text_standard->create_paragraph_style(marker, font_name, font_size, italic, bold, underline, smallcaps,
                                                      text_alignment, space_before, space_after, left_margin,
                                                      right_margin, first_line_indent, keep_with_next, drop_caps);
        if (odf_text_text_only)
            odf_text_text_only->create_paragraph_style(marker, font_name, font_size, italic, bold, underline, smallcaps,
                                                       text_alignment, space_before, space_after, left_margin,
                                                       right_margin, first_line_indent, keep_with_next, drop_caps);
        if (odf_text_text_and_note_citations)
            odf_text_text_and_note_citations->create_paragraph_style(marker, font_name, font_size, italic, bold,
                                                                     underline, smallcaps, text_alignment, space_before,
                                                                     space_after, left_margin, right_margin,
                                                                     first_line_indent, keep_with_next, drop_caps);
        if (odf_text_notes)
            odf_text_notes->create_paragraph_style(marker, font_name, font_size, italic, bold, underline, smallcaps,
                                                   text_alignment, 0, 0, 0, 0, 0, keep_with_next, drop_caps);
        created_styles.push_back(marker);
    }
}
...
std::map<int, std::string> Filter_Text::getVersesText()
{
    ...
    for (auto& text : m_verses_text | std::views::values)
    {
...
{
    int offset{0};
    const int i_verse = filter::string::convert_to_int(m_current_verse_number);
    if (m_verses_text.contains(i_verse))
    {
        offset = static_cast<int>(m_verses_text[i_verse].size());
    }
    verses_text_note_positions[i_verse].push_back(offset);
}
...
void Filter_Text::close_text_style_all() const
{
    if (odf_text_standard)
        odf_text_standard->close_text_style(false, false);
    if (odf_text_text_only)
...
std::string Filter_Text::handle_tilde_and_double_slash(std::string text)
{
    ...
    if (constexpr auto tilde{"~"}; text.find(tilde) != std::string::npos)
    {
    ...
    if (constexpr auto double_slash{"//"}; text.find(double_slash) != std::string::npos)
    {
