...
TEST (DISABLED_memory, basic)
{
  ...
  refresh_sandbox (false);
  {
    ...
    demo_create_sample_bible ();
    std::string bible = demo_sample_bible_name ();
    database::config::bible::setCheckDoubleSpacesUsfm (bible, true);
    database::config::bible::setCheckFullStopInHeadings (bible, true);
    database::config::bible::setCheckSpaceBeforePunctuation (bible, true);
    database::config::bible::setCheckSentenceStructure (bible, true);
    database::config::bible::setCheckParagraphStructure (bible, true);
    database::config::bible::setCheckBooksVersification (bible, true);
    database::config::bible::setCheckChaptesVersesVersification (bible, true);
    database::config::bible::setCheckWellFormedUsfm (bible, true);
    database::config::bible::setCheckMissingPunctuationEndVerse (bible, true);
    database::config::bible::setCheckPatterns (bible, true);
    database::config::bible::setCheckMatchingPairs (bible, true);
