...
void test_merge ()
{
  ...
  // Merge situation taken from real life.
  {
    vector <Merge_Conflict> conflicts;
    string path;
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_1_base.usfm"});
    string mergeBaseData = filter_url_file_get_contents (path);
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_1_modification.usfm"});
    string userModificationData = filter_url_file_get_contents (path);
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_1_server.usfm"});
    string serverModificationData = filter_url_file_get_contents (path);
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_1_result.usfm"});
  ...
  // Merge situation taken from real life.
  {
    vector <Merge_Conflict> conflicts;
    string path;
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_2_base.usfm"});
    string mergeBaseData = filter_url_file_get_contents (path);
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_2_modification.usfm"});
    string userModificationData = filter_url_file_get_contents (path);
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_2_server.usfm"});
    string serverModificationData = filter_url_file_get_contents (path);
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_2_result.usfm"});
    string standard = filter_url_file_get_contents (path);
  ...
  // Merge situation taken from real life in July 2020.
  {
    vector <Merge_Conflict> conflicts;
    string path;
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_3_base.usfm"});
    string mergeBaseData = filter_url_file_get_contents (path);
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_3_modification.usfm"});
    string userModificationData = filter_url_file_get_contents (path);
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_3_server.usfm"});
    string serverModificationData = filter_url_file_get_contents (path);
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_3_result.usfm"});
    string standard = filter_url_file_get_contents (path);
  ...
  // Merge situation taken from issue https://github.com/bibledit/cloud/issues/418
  {
    vector <Merge_Conflict> conflicts;
    string path;
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_4_base.usfm"});
    string mergeBaseData = filter_url_file_get_contents (path);
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_4_modification.usfm"});
    string userModificationData = filter_url_file_get_contents (path);
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_4_server.usfm"});
    string serverModificationData = filter_url_file_get_contents (path);
    path = filter_url_create_root_path_cpp17 ({"unittests", "tests", "merge_4_result.usfm"});
    string standard = filter_url_file_get_contents (path);
