...
{
  return filter_url_create_root_path_cpp17_Todo ({database_logic_databases (), "client", "usfm_resources.txt"});
}
...
{
  return filter_url_create_root_path_cpp17_Todo ({database_logic_databases (), "client", "no_cache_resources.txt"});
}
