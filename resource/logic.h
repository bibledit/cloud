...
bool resource_logic_parse_comparative_resource_v2 (string input, string * title = nullptr, string * base = nullptr, string * update = nullptr, string * remove = nullptr, string * replace = nullptr);
string resource_logic_assemble_comparative_resource_v2 (string title, string base = "", string update = "", string remove = "", string replace = "");
