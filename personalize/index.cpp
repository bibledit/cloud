...
std::string personalize_index (Webserver_Request& webserver_request)
{
  ...
  // Set the chosen theme on the option HTML tag.
  {
    ...
    const std::string html {dialog_select_create_options (values, names, std::to_string(theme))};
  ...
  }
  {
    ...
    const std::string html {dialog_select_create_options (values, texts, std::to_string(editor_key))};
  ...
  }
  {
    ...
    const std::string html {dialog_select_create_options (values, texts, editor_key)};
  ...
  }
  {
    ...
    view.set_variable ("verseseparatoroptags", dialog_select_create_options (values, texts, separator_key));
  ...
  }
  {
    ...
    const std::string html {dialog_select_create_options (values, texts, date_format_key)};
